...
import resImg from "../../assets/restaurant-1.png";
import {
  FaEdit,
  FaTrash,
  FaChevronDown,
  ...
  return (
    <div className="overflow-hidden h-w-full bg-gray-50">
      <main className="w-full my-1 ">
        <div className="bg-pink-100 w-full flex gap-130  px-10 py-7">
          <div className="flex gap-8">
            <img src={resImg} alt="" className="h-33 w-56 rounded-xl mx-auto mt-1"  />
            <div className="mt-3">
              <h2 className="text-4xl font-bold">Spice Villa</h2>
              <p className=" flex mt-1 text-lg text-gray-500">
                North Indian, Chinese <br />
                
              </p>
              <p className="flex items-center mt-1 gap-2"> <FaMapMarkerAlt size={24}/> <span className="text-xl ">Bhopal</span></p>
          ...
          <div>
            {" "}
            <h3   className="text-3xl flex items-center gap-4 font-bold "><FaUtensils size={50} />Menu Management</h3>
        ...
        <div className="flex h-[calc(100vh-70px)] w-full mx-10 gap-6 mt-6">
                ...
                <tr>
                  ...
                  <td className="  px-3 py-3">
                    ...
                    <p className="text-xs mt-2 text-gray-500">
                      Aromatic basmati rice with tender <br /> chikcken and
                      spices
                    </p>
                  </td>
          ...
          <form className="w-[380px] h-fit shrink-0 border p-5 mr-17 rounded-2xl shadow-lg border-gray-200">
            <h2 className="text-2xl font-semibold my-3  ">Add New Menu Items</h2>
            <div className="">
            ...
            <div className="mt-3">
              ...
              <label
                className="flex flex-col items-center justify-center mt-1 h-24 border border-dashed border-gray-400 rounded-lg"
                htmlFor=""
              >
                <FaImage size={24} />
            ...
            <div className="w-full flex mt-6 justify-center items-center">
              <button className="w-87 h-10 rounded-md bg-red-600 text-white text-lg">
                Add Item
              </button>
            </div>
          </form>
