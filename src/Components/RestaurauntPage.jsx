    ...
    <div className="mr-10 ml-10 mt-2 ">
      <div>
        <div className="sticky top-0 flex justify-between rounded-md shadow-xl p-8 m-1 z-2 bg-white">
          <div style={{ width: "70%" }}>
            ...
            <p className="text-gray-600 text-xl">
              Zone 1, Opposite RBI, Near Parmali Wallace Complex, Narmadapuram
              Road, Maharana Pratap Nagar, Bhopa
            </p>
            <div className="flex mt-5">
              <div className="rounded-4xl border p-2 whitespace-nowrap flex px-4 border-gray-300">
                <div className="text-green-400 border-gray-300 border-r pr-2 mr-2">
                  Open
                </div>
                <div>9am-12am</div>
              </div>
              <div className=" border-r border-l mr-3 ml-4 pr-2 pl-2 flex items-center whitespace-nowrap border-gray-300">
                $100, for two
              </div>
              <div className="flex">
                <div className="underline flex items-center border-gray-300">
                  7415793311
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-between ml-10 items-center  ">
            <div className="flex mr-9 ">
              <div className="h-10 bg-green-900 w-20 rounded-xl flex items-center justify-center mr-2 text-2xl text-white">
                {" "}
                ★ 4.5
              </div>
              <div>
                <div className="text-xl font-bold">275</div>
                <div className="text-xs underline whitespace-nowrap ">
                  Dinning Ratings
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-6">
          <img
            className="p-1 h-full col-span-2 rounded-xl "
            src="https://images.squarespace-cdn.com/content/v1/587288fb197aea5ae694ef6b/19e05115-755e-44dc-b40e-59c24b722bf4/Copy%2Bof%2BF68A9232.jpg?format=2500w"
            alt=""
          />

          <img
            className="p-1 h-full rounded-xl col-span-2"
            src="https://digital.ihg.com/is/image/ihg/holiday-inn-glasgow-6003118133-original"
            alt=""
          />
          <img
            className="p-1 h-full rounded-xl col-span-2"
        ...
        <div className=" border-b-2 gap-14 border-gray-200 mt-6 pb-6 pl-4  flex">
          <button
            className={`text-2xl  ${tab == "overview" ? "border-b-2 border-red-400 text-red-400" : "none"}`}
            onClick={() => {
              settab("overview");
            }}
          >
          ...
          <button
            className={`text-2xl  ${tab == "Reviews" ? "border-b-2 border-red-400 text-red-400" : "none"}`}
            onClick={() => {
              settab("Reviews");
            }}
          >
          ...
          <button
            className={`text-2xl  ${tab == "photos" ? "border-b-2 border-red-400 text-red-400" : "none"}`}
            onClick={() => {
              settab("photos");
            }}
          >
          ...
          <button
            className={`text-2xl  ${tab == "menu" ? "border-b-2 border-red-400 text-red-400" : "none"}`}
            onClick={() => {
              settab("menu");
            }}
          >
          ...
          {role == "seller" && (
            <button
              className={`text-2xl  ${tab == "myitems" ? "border-b-2 border-red-400 text-red-400" : "none"}`}
              onClick={() => {
                settab("myitems");
              }}
            >
        ...
        <>
          <div className="p-4 rounded-xl shadow-sm mt-6 z-1 ">
            ...
            <div>
              ...
              <div className="flex gap-8">
                <div className="rounded-4xl border p-2 pr-4 pl-4 border-gray-400">
                  North Indian
                </div>
                <div className="rounded-4xl border p-2 pr-4 pl-4  border-gray-400">
                  South Indian
          ...
          <div className="p-4 rounded-xl shadow-sm mt-6 z-1 mb-3 ">
            ...
            <div className="text-2xl">
              $100 for two people (approx.) Without alcohol
            </div>
          ...
          <div className="grid grid-cols-3">
            <div className="p-4  rounded-xl m-4 bg-gray-50">
              <div className="flex justify-between">
                ...
                <div className=" mt-4 h-8 bg-green-900  w-18 rounded-md flex items-center justify-center mr-2 text-2xl text-white">
                  4.2
                </div>
              </div>
            ...
            <div className="p-4  rounded-xl m-4 bg-gray-50">
              ...
              <div className="text-xl text-gray-800 mt-5">
                Miss management of order
              </div>
            </div>
          ...
          <div className="grid grid-cols-4  m-1">
            <div className="rounded-xl shadow-2xl m-4 ">
              ...
              <div className="p-2 ">
                ...
                <div className="text-gray-500 ">
                  Layers Of Sponge, Chocolate Cream And Mouth Melting Truffle
                  Sauce
                </div>
                <button className="bg-red-600 mb-1 py-1  px-2 mt-2 rounded-md text-white">
                  Add to cart
                </button>
              </div>
            </div>
