...
import { FaMotorcycle, FaHeadset } from "react-icons/fa";
      ...
      <div className=" mx-30 mt-6 ">
        ...
        <div className="flex gap-6 mt-6">
            ...
            <div className="p-2 border-b border-gray-200 flex justify-between w-2xl">
              <div className="flex gap-3 w-60">
                <img
                  ...
                  className="rounded-xl h-20 w-25 object-fit"
                  alt=""
                />
                <div>
          ...
          <div className="rounded-xl p-4 shadow-[0_0_15px_rgba(0,0,0,0.3)] w-[25vw]">
            ...
            <button className="w-full bg-red-500 text-white py-1 mt-5 rounded-md flex justify-center">
              Place Order <ChevronRight size={25} />
            </button>
          </div>
        </div>
            ...
            <div className=" rounded-md flex">
              ...
              <div>
                <div className="p-3 flex gap-3">
                  ...
                  <div className="bg-red-300 text-red-800 px-2 rounded-xl text-sm justify-center flex items-center">
                    Default
                  </div>
                </div>
                <div className="px-3">
          ...
          <div className="rounded-xl shadow-[0_0_15px_rgba(0,0,0,0.3)] p-3 w-85">
            ...
            <div className="rounded-xl">
              <div className=" border-b border-gray-300  flex justify-between">
                ...
                >
                  <div
                    className={`p-2 font-bold ${payment == "cod" ? "text-red-600" : ""}`}
                  >
                    O
                  </div>
                  <div className="p-2 ">
              ...
              <div className=" border-b border-gray-300  flex justify-between">
                ...
                >
                  <div
                    className={`p-2 font-bold ${payment == "upi" ? "text-red-600" : ""}`}
                  >
                    O
                  </div>
                  <div className="p-2 ">
              ...
              <div className=" border-b border-gray-300  flex justify-between">
                ...
                >
                  <div
                    className={`p-2 font-bold ${payment == "card" ? "text-red-600" : ""}`}
                  >
                    O
                  </div>
                  <div className="p-2 ">
