  ...
  const [count,setcount]=useState(4)
    let totalcost=(i)=>{
     ...
     let remove=(i)=>{
              ...
              if (i=="i1") {
            setcost((prev)=>(prev- 2))
             setitems((prev)=>({...prev,i1:prev.i1-1}))
           }
            if (i=="i2") {
            setcost((prev)=>(prev- 2))
             setitems((prev)=>({...prev,i2:prev.i2-1}))
           }
            if (i=="i3") {
            setcost((prev)=>(prev- 2))
            setitems((prev)=>({...prev,i3:prev.i3-1}))
           }
            if (i=="i4") {
            setcost((prev)=>(prev- 3))
            setitems((prev)=>({...prev,i4:prev.i4-1}))
           }
...
<div className=' mx-30 mt-6 '> 
  <div className='flex gap-4'>
    ...
    <div className='text-gray-500 text-sm'>{count} items in your cart</div></div>
  </div>
  <div className='flex gap-9 mt-6'>
    <div className='rounded-xl p-2 px-8 shadow-[0_0_10px_rgba(0,0,0,0.1)] '>
        {/* 1 */}
        <div className='p-2 border-b border-gray-200 flex justify-between w-3xl'>
 ...
 <div className='flex justify-center items-center'>
    <div className='flex justify-between rounded-md w-30  px-2 py-1 gap-4 bg-gray-50'>
     <button className='text-lg' onClick={()=>{items.i1>0?remove("i1"):null }}>-</button>
...
<Trash2 size={25}/>
    ...
    <div className='rounded-xl p-4 shadow-[0_0_10px_rgba(0,0,0,0.1)] w-[32vw]'>
       ...
       <button className='w-full bg-red-500 text-white py-2 mt-5 rounded-md flex justify-center'>Place Order <ChevronRight size={25}/></button>

    </div>
  </div>

  <div className='flex gap-8 mt-6 w-full'>
<div className='rounded-xl p-3 shadow-[0_0_10px_rgba(0,0,0,0.1)] w-98 '>
...
<div className='rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.1)] p-3 w-102'>
    <div className='pb-1 flex gap-3'>
...
<img src={Aesthetic} className='rounded-xl m object-cover w-118 h-45' alt="" />
</div>
    </div>
